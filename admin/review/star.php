...
<link rel="stylesheet" href="admin/review/star.css">
...
<script type="text/javascript">
          if(getCookie('showRate') == null || getCookie('showRate') == 1){
             $('.wp_rate').show();
        }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="bootbox-body" style="margin-bottom: 20px">Let us know
                        ...
                        building the best possible version of <?php echo $app_settings->app_name ?>, and we appreciate
    ...
    <div  role="dialog" onclick="hidenDiv()" id="moda_rating_good" tabindex="-1" class="bootbox modal fade in" style="display: block; padding-right: 15px;  background: #00000047;">
        <div class="modal-dialog" style="text-align: left;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="bootbox-body" style="margin-bottom: 20px">We're so happy that you like <?php echo $app_settings->app_name ?> app and gave it a high rate. Could you please spend 2 minutes leaving us a good review on Shopify App Store? Your review means a lot to us.</div>
                </div>
                <div class="modal-footer">
...
<div class="respone"> 
    <div class="improveStarRespone" style="display: none;"> 
        ...
        <p>Thank you for feedback. We will build the best possible version of facebook review.</p>
    </div> 
